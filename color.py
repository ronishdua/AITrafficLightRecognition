...
# Try to identify RED, YELLOW and GREEN
...
if __name__ == "__main__":
    p = PlotPic(
        [
            TransferColor(day_r, "a"),
            TransferColor(day_r, "l_luv"),
            TransferColor(day_g, "a"),
            TransferColor(day_g, "l_luv"),
            TransferColor(day_y, "a"),
            TransferColor(day_y, "l_luv"),
        ]
    )
